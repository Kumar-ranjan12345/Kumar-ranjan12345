...
### Mobile Software Engineer | iOS • Android | Swift • Kotlin

Building production-grade native applications and exploring backend systems, distributed architecture, and scalable software design.
...
Security-focused utilities and helpers for iOS applications.

Built to improve code safety, application integrity, and security best practices.
...
![SwiftUI](https://img.shields.io/badge/SwiftUI-0D96F6?style=flat-square)
...
![MVVM](https://img.shields.io/badge/MVVM-00599C?style=flat-square)
![Clean Architecture](https://img.shields.io/badge/Clean_Architecture-000000?style=flat-square)
![Modularization](https://img.shields.io/badge/Modularization-4285F4?style=flat-square)
...
### Open to collaborating on meaningful mobile, backend, and open-source projects.
